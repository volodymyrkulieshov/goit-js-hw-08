...
l=setTimeout(j,t),S(u))}return void 0===l&&(l=setTimeout(j,t)),f}return t=b(t)||0,y(n)&&(s=!!n.leading,a=(g="maxWait"in n)?d(b(n.maxWait)||0,t):a,m="trailing"in n?!!n.trailing:m),h.cancel=function(){void 0!==l&&clearTimeout(l),c=0,o=u=r=l=void 0},h.flush=function(){return void 0===l?f:T(p())},h}(e,t,{leading:o,maxWait:t,trailing:r})};let S="feedback-form-state",O=document.querySelector(".feedback-form"),j=O[name="email"],T=O[name="message"];(function(){let e=JSON.parse(localStorage.getItem(S));console.log(e),e&&(e.message&&(T.value=e.message),e.email&&(j.value=e.email))})(),O.addEventListener("submit",function(e){if(e.preventDefault(),""===j.value||""===T.value)return;let t=JSON.parse(localStorage.getItem(S));console.log(t),e.currentTarget.reset(),localStorage.removeItem(S)}),O.addEventListener("input",((e=n)&&e.__esModule?e.default:e)(function(e){let t={email:j.value,message:T.value};localStorage.setItem(S,JSON.stringify(t)),t[e.target.name]=e.target.value,localStorage.setItem(S,JSON.stringify(t))},500))}();//# sourceMappingURL=03-feedback.a4d96cea.js.map

//# sourceMappingURL=03-feedback.a4d96cea.js.map
