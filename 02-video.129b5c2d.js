...
ep.style.margin="20px auto",ep.style.display="flex";let ev=new B(ep);// console.log(player);
ev.on("timeupdate",((a=J)&&a.__esModule?a.default:a)(function({seconds:e}){localStorage.setItem(eh,e)},1e3)),ev.setCurrentTime(localStorage.getItem(eh)||0)}();//# sourceMappingURL=02-video.129b5c2d.js.map

//# sourceMappingURL=02-video.129b5c2d.js.map
