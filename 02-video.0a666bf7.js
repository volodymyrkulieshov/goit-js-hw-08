...
u=setTimeout(v,t),h(c))}return void 0===u&&(u=setTimeout(v,t)),a}return t=ed(t)||0,ef(n)&&(s=!!n.leading,i=(f="maxWait"in n)?ec(ed(n.maxWait)||0,t):i,d="trailing"in n?!!n.trailing:d),m.cancel=function(){void 0!==u&&clearTimeout(u),l=0,r=c=o=u=void 0},m.flush=function(){return void 0===u?a:y(es())},m}(e,t,{leading:r,maxWait:t,trailing:o})};const eh="videoplayer-current-time",ep=document.querySelector("iframe");// console.log(iframe);
ep.style.margin="20px auto",ep.style.display="flex";const ev=new B(ep);// console.log(player);
ev.on("timeupdate",((a=J)&&a.__esModule?a.default:a)(function({seconds:e}){localStorage.setItem(eh,e)},1e3)),ev.setCurrentTime(localStorage.getItem(eh)||0);//# sourceMappingURL=02-video.0a666bf7.js.map

//# sourceMappingURL=02-video.0a666bf7.js.map
